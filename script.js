...
*/
Papa.parse("https://raw.githubusercontent.com/margaraitavialm/dno037_clase05/main/indice-uso-cobre.csv", {
    download: true,
    header: true,
    dynamicTyping: true,
                ...
                new Chart(document.querySelector("#grafico").getContext("2d"), {
                    ...
                    data: {
                        ...
                        datasets: [
                            {
                                data: indice,
                                backgroundColor: "rgba(4, 66, 101, .3)",
                                borderColor: "rgba(4, 66, 101, .5)",
                                pointRadius: 2,
                                borderWidth: 1,
                                lineTension: 0,
                            },
